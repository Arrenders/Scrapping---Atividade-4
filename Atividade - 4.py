...
CidadesPesquisa = ['Bauru, São Paulo, Brasil', 'Ribeirão Preto, São Paulo, Brasil', 'Lençóis Paulista, São Paulo, Brasil']

#Browser Visible
driver = webdriver.Firefox(executable_path="C:/Pos_Graduacao/Web_Scraping_Crawlers/Selenium/geckodriver")
